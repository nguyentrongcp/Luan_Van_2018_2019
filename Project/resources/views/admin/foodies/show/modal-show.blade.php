...
{{--@foreach($foodies as $fd)--}}
    {{--<div class="modal fade" id="modal-info-fd-{{$fd->id}}" tabindex="-1" role="dialog"--}}
         {{--aria-labelledby="exampleModalCenterTitle" aria-hidden="true">--}}
        {{--<div class="modal-dialog modal-dialog-top modal-info-product" role="document">--}}
            {{--<div class="modal-content">--}}
                {{--<div class="modal-header">--}}
                    {{--<h5 class="modal-title title text-black-50" id="exampleModalCenterTitle">{{$fd->name}}</h5>--}}
                    ...
                    {{--<div class="row col-12">--}}
                        {{--<div class="col-6">--}}
                            {{--<table>--}}
                                ...
                                {{--<tr>--}}
                                    ...
                                    {{--@foreach(App\Cost::where('product_id',$fd->id)->get() as $costPro)--}}
                        ...
                        {{--<div class="col-6">--}}
                            ...
                            {{--<div class="img-avatar">--}}
                                ...
                                {{--</div>--}}
                                {{--<div class="gallery">--}}
                                    {{--<img src="{{asset($fd->avatar)}}" alt="{{$fd->name}}">--}}
                                {{--</div>--}}
                            {{--</div>--}}
...
{{--<<<<<<< HEAD--}}
                                                {{--@foreach (App\ImageProduct::where('product_id',$fd->id)->get() as $idImage)--}}
                                                    {{--@foreach (App\Image::where('id',$idImage->image_id)->get() as $id)--}}
{{--=======--}}
                                                {{--@foreach(App\ImageFoody::where('product_id',$fd->id) as $idImage)--}}
