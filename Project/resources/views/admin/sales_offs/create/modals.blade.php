...
<div class="modal fade" id="modal-create-sales" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-size">
            ...
            <div class="modal-body">
                <form action="{{route('create_sales.store')}}" method="post">
                    {{ csrf_field() }}
                    <input type="hidden" value="{{$id}}" name="id-sales">
                    <div class="form-group">
                        <label class="title">Tên khuyến mãi</label>
                        <input type="text" class="form-control" name="name-sales" id="name-sales"
                               placeholder="Nhập tên loại..." value="KM 01-06 Quốc tế thiếu nhi" minlength="5" required>
                    </div>
                    <div class="form-group">
